<?php
	...
	function singIn($email, $password){
		...
		if ($stmt->fetch()){
			...
			$notice = "Selle kasutaja (" . $email .") ei ole";
		}
		return $notice;
	}

	// uue kasutaja andmebaasi lisamine
	function singUp($signupFirstName, $signupFamilyName, $signupBirthDate, $gender, $signupEmail, $signupPassword){
